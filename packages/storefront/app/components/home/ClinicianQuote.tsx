      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <figure className="text-center">
          ...
          <blockquote className="text-xl font-medium text-[var(--text-primary)] sm:text-2xl">
            &ldquo;Most recovery devices are marketing. RegenAI&rsquo;s clinician-review process gets the copy as close to the evidence as I&rsquo;ve seen on a DTC site.&rdquo;
          </blockquote>
